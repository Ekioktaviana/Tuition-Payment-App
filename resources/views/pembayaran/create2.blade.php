...
@section('content')
    <div class="container">
        ...
        <hr>
        <form action="{{ route('pembayaran.store2') }}" method="post">
                @csrf
                @method('POST')
                ...
                <div class="row mb-4">                        
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                        <label for="jumlah_bayar">Jumlah Bulan Bayar :</label>
                                        <input type="number" min="1" required class="form-control" name="jumlah_bulan_bayar" id="jumlah_bulan_bayar" required>
                                </div>
                        </div>
                </div>
